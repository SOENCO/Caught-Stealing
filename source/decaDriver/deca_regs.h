...
/*masks */
#define SYS_STATUS_MASK_32      (uint32_t)0xFFF7FFFFUL    /* System event Status Register access mask (all unused fields should always be writen as zero) */
/*offset 0 */
#define SYS_STATUS_IRQS         (uint32_t)0x00000001UL    /* Interrupt Request Status READ ONLY */
#define SYS_STATUS_CPLOCK       (uint32_t)0x00000002UL    /* Clock PLL Lock */
#define SYS_STATUS_ESYNCR       (uint32_t)0x00000004UL    /* External Sync Clock Reset */
#define SYS_STATUS_AAT          (uint32_t)0x00000008UL    /* Automatic Acknowledge Trigger */
#define SYS_STATUS_TXFRB        (uint32_t)0x00000010UL    /* Transmit Frame Begins */
#define SYS_STATUS_TXPRS        (uint32_t)0x00000020UL    /* Transmit Preamble Sent */
#define SYS_STATUS_TXPHS        (uint32_t)0x00000040UL    /* Transmit PHY Header Sent */
#define SYS_STATUS_TXFRS        (uint32_t)0x00000080UL    /* Transmit Frame Sent: This is set when the transmitter has completed the sending of a frame */
/*offset 8 */
#define SYS_STATUS_RXPRD        (uint32_t)0x00000100UL    /* Receiver Preamble Detected status */
#define SYS_STATUS_RXSFDD       (uint32_t)0x00000200UL    /* Receiver Start Frame Delimiter Detected. */
#define SYS_STATUS_LDEDONE      (uint32_t)0x00000400UL    /* LDE processing done */
#define SYS_STATUS_RXPHD        (uint32_t)0x00000800UL    /* Receiver PHY Header Detect */
#define SYS_STATUS_RXPHE        (uint32_t)0x00001000UL    /* Receiver PHY Header Error */
#define SYS_STATUS_RXDFR        (uint32_t)0x00002000UL    /* Receiver Data Frame Ready */
#define SYS_STATUS_RXFCG        (uint32_t)0x00004000UL    /* Receiver FCS Good */
#define SYS_STATUS_RXFCE        (uint32_t)0x00008000UL    /* Receiver FCS Error */
/*offset 16 */
#define SYS_STATUS_RXRFSL       (uint32_t)0x00010000UL    /* Receiver Reed Solomon Frame Sync Loss */
#define SYS_STATUS_RXRFTO       (uint32_t)0x00020000UL    /* Receive Frame Wait Timeout */
#define SYS_STATUS_LDEERR       (uint32_t)0x00040000UL    /* Leading edge detection processing error */
#define SYS_STATUS_reserved     (uint32_t)0x00080000UL    /* bit19 reserved */
#define SYS_STATUS_RXOVRR       (uint32_t)0x00100000UL    /* Receiver Overrun */
#define SYS_STATUS_RXPTO        (uint32_t)0x00200000UL    /* Preamble detection timeout */
#define SYS_STATUS_GPIOIRQ      (uint32_t)0x00400000UL    /* GPIO interrupt */
#define SYS_STATUS_SLP2INIT     (uint32_t)0x00800000UL    /* SLEEP to INIT */
/*offset 24 */
#define SYS_STATUS_RFPLL_LL     (uint32_t)0x01000000UL    /* RF PLL Losing Lock */
#define SYS_STATUS_CLKPLL_LL    (uint32_t)0x02000000UL    /* Clock PLL Losing Lock */
#define SYS_STATUS_RXSFDTO      (uint32_t)0x04000000UL    /* Receive SFD timeout */
#define SYS_STATUS_HPDWARN      (uint32_t)0x08000000UL    /* Half Period Delay Warning */
#define SYS_STATUS_TXBERR       (uint32_t)0x10000000UL    /* Transmit Buffer Error */
#define SYS_STATUS_AFFREJ       (uint32_t)0x20000000UL    /* Automatic Frame Filtering rejection */
#define SYS_STATUS_HSRBP        (uint32_t)0x40000000UL    /* Host Side Receive Buffer Pointer */
#define SYS_STATUS_ICRBP        (uint32_t)0x80000000UL    /* IC side Receive Buffer Pointer READ ONLY */
/*offset 32 */
